# Testing for iterm2-mcp

This directory contains tests for the iterm2-mcp project.
...
We aim for good test coverage of all core functionality. Run `npm run test:coverage` to see the current coverage report.
